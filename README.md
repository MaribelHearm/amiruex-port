...
个人数字门户，基于 Payload CMS 3.x + Next.js 16 App Router。连接工程、创作与生活。
...
- 首页 Hero 打字机文案已切换为当前项目语境（云端持续迭代 / 规范沉淀 / 工具交付）。
- 首页 `SYS · STATUS` 已从阶段开发表述更新为云端稳定运行与多版本迭代状态。
- 首页状态卡（原 `PHASE 07 / ACTIVE DEVELOPMENT`）已更新为维护增强阶段文案。
- About 页「留白区（持续扩展）」支持按换行自动分段，并识别列表与小标题，避免大段文本挤成一段。
- 新增并固化项目规则：
  - `.roo/rules/design-system.md`（UI 风格门禁）
  - `.roo/rules/tools-workflow.md`（新工具上云交付三件套门禁）
...
- [Amireux Personal Portal — next-portal](#amireux-personal-portal--next-portal)
  ...
  - [最近更新（2026-04-11）](#最近更新2026-04-11)
  - [当前限制](#当前限制)
  - [计划 / 未来改进](#计划--未来改进)
  - [私有基础设施门户](#私有基础设施门户)
